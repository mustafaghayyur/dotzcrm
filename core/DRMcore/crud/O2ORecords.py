...
class CRUD(Background.Operations):
    ...
    def create(self, dictionary):
        ...
        masterRecord = Create.masterTable(self.mapper.master('abbreviation'), self.mtModel)
        ...
        for pk in self.idCols:
            ...
            Create.childTable(t['model'], tbl, t['table'], t['cols'])
        ...
        for pk in self.idCols:
            ...
            if pk == mId:
                if crud.isValidId(self.submission, pk):
                    Update.masterTable(t['model'], t['table'], t['cols'], completeRecord)
                    continue
            ...
            Update.childTable(t['model'], tbl, t['table'], t['cols'], completeRecord)
    ...
    def delete(self, masterId):
        ...
        for pk in self.idCols:
            ...
            Delete.childTable(t['model'], tbl, t['table'], t['cols'], masterId)
        ...
        return Delete.masterTable(t['model'], self.mapper.master('foreignKeyName'), t['table'], t['cols'], masterId)
