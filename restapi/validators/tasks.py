...
class TaskO2ORecord(BaseModel):
    ...
    deadline: Annotated[datetime, AfterValidator(crud.isFutureDatetime)]
    ...
    dlatest: Annotated[Latest, Field(max_length=1)]
    llatest: Annotated[Latest, Field(max_length=1)]
    slatest: Annotated[Latest, Field(max_length=1)]
    alatest: Annotated[Latest, Field(max_length=1)]
    vlatest: Annotated[Latest, Field(max_length=1)]

    tcreate_time: Annotated[datetime, Field(default_factory=timezone.now), AfterValidator(crud.isPastDatetime)]
    dcreate_time: Annotated[datetime, Field(default_factory=timezone.now), AfterValidator(crud.isPastDatetime)]
    lcreate_time: Annotated[datetime, Field(default_factory=timezone.now), AfterValidator(crud.isPastDatetime)]
    screate_time: Annotated[datetime, Field(default_factory=timezone.now), AfterValidator(crud.isPastDatetime)]
    acreate_time: Annotated[datetime, Field(default_factory=timezone.now), AfterValidator(crud.isPastDatetime)]
    vcreate_time: Annotated[datetime, Field(default_factory=timezone.now), AfterValidator(crud.isPastDatetime)]
