  ...
  function renderData(tabName, data) {
    ...
    if (Array.isArray(data)) {
      ...
      data.forEach(item => {
        ...
        if (tabName == 'private') {
            more = '<a class="btn position-absolute top-0 end-0 m-3" data-bs-toggle="collapse" href="#collapseExample-' + escapeHtml(item.id) + '" role="button" aria-expanded="false" aria-controls="collapseExample-' + escapeHtml(item.id) + '"><i class="bi bi-arrow-down"></i></a>'
